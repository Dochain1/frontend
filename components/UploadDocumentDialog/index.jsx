...
const UploadDocumentDialog = ({ caseId }) => {
  ...
  return (
    <>
      <button
        className="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center xy-2 "
        type="button"
              ...
              <div className="inline-block align-bottom  rounded-lg text-left overflow-hidden transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div className="bg-white rounded-lg overflow-hidden shadow-xl">
                  <div className="flex justify-between items-center p-5 rounded-t border-b bg-slate-400">
                    ...
                    <button
                      type="button"
                      className="bg-gray-200 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
                      onClick={() => closeDialog()}
                    >
                      <svg
                        aria-hidden="true"
                  ...
                  <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 ">
                    <form
                      action="https://api-dochain.herokuapp.com/api/v1/documents/upload"
                      method="post"
